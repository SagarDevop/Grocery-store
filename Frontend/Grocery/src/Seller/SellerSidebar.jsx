...
const menuItems = [
  ...
  { icon: Package, label: "My Products", path: "/seller-dashboard/sellerproductlist" },
  ...
  { icon: TrendingUp, label: "Earnings", path: "/seller-dashboard/earnings" },
      ...
      <div className="flex flex-col h-full p-4 overflow-hidden">
          ...
          {!isCollapsed && (
            <div className="flex flex-col truncate">
                <span className="font-bold text-lg tracking-tight text-gray-900 leading-none">
                    Seller<span className="text-emerald-600">Hub</span>
                </span>
                <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Vendor Panel</span>
            </div>
          )}
        </div>
        ...
        <div className="pt-4 border-t border-gray-100 space-y-2">
          <button 
            ...
            className="flex items-center gap-3 p-3 rounded-xl w-full text-red-500 hover:bg-red-50 transition-colors"
          >
